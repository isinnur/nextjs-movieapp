...
const getMovie = async (id) => {
  const res = await fetch(
    `https://api.themoviedb.org/3/movie/${id}?api_key=0699b27cb753aebe336f5c310edef70b `
  );
...
const page = async ({ params }) => {
  ...
  console.log(id, "id");
  return (
    <div className=" flex flex-col  relative p-7 min-h-screen">
      <Image
      ...
      <div className="items-center">
        ...
        <div className="w-1/2 text-amber-600 my-3">
